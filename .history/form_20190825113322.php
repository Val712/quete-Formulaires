<form  action="form.php"  method="post">
    ...
    <div>
        ...
        <label for="tel">Téléphone :</label>
        <label for="tel">Téléphone :</label>[0
        <input type="tel" id="tel" name="user_tel" required placeholder="ex : 0559563289"pattern="[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}" >
    </div>
    <div>
