<form  action="reponse.php"  method="post">
    ...
    <div>
        ...
        <input type="tel" id="tel" name="user_tel" required placeholder="ex : 0559563289" pattern="[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}" maxlength="14">
    </div>
    <div>
    ...
    <div>
        ...
        <textarea id="msg" name="user_message" required placeholder="écrivez ici votre message"rows="10" cols="50" maxlength="255"></textarea>
    </div> </br>
