<form  action="form.php"  method="post">
    ...
    <div>
        ...
        <input type="tel" id="tel" name="user_tel" required placeholder="ex : 0559563289">
    </div>
    <div>
    ...
    <div>
        ...
        <textarea id="msg" name="user_message" required placeholder="écrivez ici votre message"maxlength="255" size="255"></textarea>
    </div> </br>
